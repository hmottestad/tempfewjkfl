  ...
  function r(e) {
      ...
      a(this, t);var e = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));return e.state = { accept: "", files: [], dropzoneActive: !1, shacl: null, validationErrors: [] }, e.validate = e.validate.bind(e), e;
        ...
        console.log(e);var t = new FileReader();t.onload = function (n) {
          var r = this,
            ...
            console.error(e), r.setState({ syntaxError: ":(" });
          });
    ...
    function t() {
      return a(this, t), i(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
        ...
        var e = this.props.id,
            t = this.props.group;return l.default.createElement("span", null, l.default.createElement("h4", null, "Ressurs ", l.default.createElement("span", { style: { color: "darkgreen" } }, e)), l.default.createElement("h6", null, "Type: ", l.default.createElement("span", { style: { color: "darkgreen" } }, M.default.prefix(t[e]["@type"]))), l.default.createElement("ul", null, Object.keys(t[e]).filter(function (e) {
          return 0 == !e.indexOf("@");
        }).map(function (n) {
          return l.default.createElement("li", { style: { listStyle: "none" } }, l.default.createElement("div", null, l.default.createElement("h7", { style: { color: "darkgreen" } }, M.default.prefix(n)), l.default.createElement("ul", null, Object.values(t[e][n]).map(function (e) {
            return l.default.createElement("li", { style: { listStyle: "none" } }, e.message);
          }))));
    ...
    function t(e, n) {
      a(this, t);var r = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));return r.in = null, r.inIdMap = {}, r.inLiteralMap = { datatype: {}, language: {}, plain: {} }, r.in = e[h.default.in][0]["@list"], r.in.forEach(function (e) {
        ...
        var r = this;u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "validate", this).call(this, e, n), e[this.path] && e[this.path].forEach(function (t) {
          try {
            if (t["@id"]) r.inIdMap[t["@id"]] || n(new p.default(r, "Fant " + t["@id"] + ", men forventet en av [ " + r.in.map(function (e) {
              return e["@id"];
            }).reduce(function (e, t) {
              return e + ", " + t;
            }) + " ]", e));else if (t["@type"]) {
              var a = !1;try {
                a = r.inLiteralMap.datatype[t["@type"]][t["@value"]];
              } catch (e) {}a || n(new p.default(r, 'Fant Fant "' + t["@value"] + '"^^<' + t["@type"] + ">, men forventet en av [ " + r.in.map(function (e) {
                return e["@id"];
              }).reduce(function (e, t) {
                return e + ", " + t;
              }) + " ]", e));
              ...
              var i = !1;try {
                i = r.inLiteralMap.language[t["@language"]][t["@value"]];
              } catch (e) {}i || n(new p.default(r, 'Fant "' + t["@value"] + '"@' + t["@language"] + ", men forventet en av [ " + r.in.map(function (e) {
                return e["@id"];
              }).reduce(function (e, t) {
                return e + ", " + t;
              }) + " ]", e));
            } else {
              var o = r.inLiteralMap.plain[t["@value"]];o || n(new p.default(r, 'Fant "' + t["@value"] + '", men forventet en av [ ' + r.in.map(function (e) {
                return e["@id"];
              }).reduce(function (e, t) {
                return e + ", " + t;
              }) + " ]", e));
            ...
            if ("TypeError" !== t.name) throw t;n(new p.default(r, "Forventet en av [ " + r.in.map(function (e) {
              return e["@id"];
            }).reduce(function (e, t) {
              return e + ", " + t;
            }) + " ]", e));
      ...
      a(this, t);var r = i(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this, e, n));return r.nodeKind = null, r.nodeKind = e[h.default.nodeKind][0]["@id"], r;
        ...
        if (u(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype), "validate", this).call(this, e, n), void 0 !== e[this.path]) {
          var r = !0,
              ...
              i = void 0;try {
            for (var o, s = e[this.path][Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
              var l = o.value;this.nodeKind === h.default.Literal && void 0 === l["@value"] ? n(new p.default(this, "Forventet en literal, eg. et tall, en dato eller en tekst", e)) : this.nodeKind === h.default.BlankNodeOrIRI && void 0 === l["@id"] ? n(new p.default(this, "Forventet en IRI eller en blank node", e)) : this.nodeKind !== h.default.IRI || void 0 !== l["@id"] && 0 !== l["@id"].indexOf("_:") || n(new p.default(this, "Forventet en IRI", e));
            }
          } catch (e) {
            a = !0, i = e;
          } finally {
...
//# sourceMappingURL=main.c696aa69.js.map
//# sourceMappingURL=main.c696aa69.js.map